...
def overhead():
    ...
    for highest in value:   
        high.append(max(value)) # append the highest overhead value using max() and .append() to the empty list
        break # break and stop the for-loop from iterating using break function
